...
const contract = JSON.parse(fs.readFileSync('../build/contracts/abi.json'));
...
app.get('/api/getNotesLen', async (req, res ) =>{
    const contract_instance = await new web3.eth.Contract( contract,contract_address ) ;
...
app.get('/api/addNote', async (req, res ) =>{
    ...
    const account1 = '0x1aaf07459Ebb2d5846ed750dda9121D7dF424D00'; 
    web3.eth.defaultAccount = account1;
    const privateKey1 = Buffer.from(privatekey, 'hex');
    const abi = contract ;
    const contract_Address = "0xd78e91b11731c9a8b94c45ef2ba67a44fd6f0c48";
    const myContract = new web3.eth.Contract(abi, contract_Address);
    const myData = myContract.methods.addNote( "currently content" ).encodeABI();
